						...
						<div class="row">
							<div class="panel panel-default" style="height: 110px;">
								...
								<table>
									...
									<thead><button class="btn btn-info" style="float: right; margin-right: 20px;">Ganti Pencarian</button></thead>
							...
							<div class="panel panel-default">
								...
								<table class="table table-bordered table-striped table-hover">
									...
									<tbody>
										...
										?>
											<tr>
												<td><img src="<?php echo base_url('assets/img/$trute->logo') ?>"></td>
												<td><?php echo $trute->depart_at ?><br><?php echo $trute->asal ?></td>
												<td><?php echo $trute->arrive ?><br><?php echo $trute->tujuan ?></td>
												<td><?php echo $trute->tujuan ?></td>
												<td>Rp. <?php echo $harga ?></td>
												<td>
													<a href="<?php echo base_url('traveler/prepare_pesan') ?>" class="btn btn-info">PESAN</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
